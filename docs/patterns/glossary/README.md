...
eq<Int>()
//arrow.instances.IntEqInstance@588e6c7a
```
...
//arrow.data.ListKWApplicativeInstanceImplicits$instance$1@75a0199e
```
...
//arrow.core.OptionApplicativeInstanceImplicits$instance$1@238d1ffc
```
